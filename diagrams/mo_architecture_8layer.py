...
graph_attr = {
    ...
    "ranksep": "0.4",
    "splines": "false",
    "label": "Red Hat OpenShift AI – Architektura řešení\nAI Appliance pro air-gap prostředí",
    "labelloc": "t",
    "labeljust": "c",
    "fontcolor": "#1A1A1A",
    "compound": "true",
...
with Diagram(
    "",
    filename="diagrams/mo_architecture_8layer",
    show=False,
    direction="TB",
